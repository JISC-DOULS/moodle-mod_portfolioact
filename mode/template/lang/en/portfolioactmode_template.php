...
$string['itemlargetextassist_help'] = 'This is the text which appears to the user as the instruction. The following codes will be replaced automatically: {date} , {courseshortname} , {activityname} , {username} . The curly braces are required. \'date\' is the current date when the item is viewed or exported.';
